...
public partial class Share_san_khoa_Right_layout : System.Web.UI.MasterPage
{
    ...
    private void getBaiMoi()
    {
        ...
        rpPost.DataSource = dt;
        rpPost.DataBind();
    }
    private void getTags()
    {
        DBClass _db = new DBClass();
        string sqlCMD = "select top 20 * from tbkeywords order by id desc";
        DataTable dt = _db.sqlGetData(sqlCMD);
        //rpTags.DataSource = dt;
        //rpTags.DataBind();
    }
