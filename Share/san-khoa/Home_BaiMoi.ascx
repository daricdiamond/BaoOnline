...
<section class=" blue" style="padding-top:30px;padding-bottom:30px;">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div class="latest-news2">
                    ...
                    <h2 class="light bordered white-f"><span>Bài</span> Mới</h2>
                                ...
                                <li>
                                    ...
                                    <article class="blog2-item">
                                        <div class="blog2-thumbnail">
                                            ...
                                            <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl='<%# "~/" + Eval("url") %>' AlternateText='<%# Eval("Title") %>'> 
                                                <img src='<%# "../UploadFile/postImages/"+Eval("HinhAnh") %>' alt='<%# Eval("Title") %>' />
                                            </asp:HyperLink>
                                        </div>
                                        <div class="blog2-content">
                                            <span class="arrow-right"></span>
                                            <h4 class="blog2-title"><a href='<%# "../" + Eval("url")  %>'><%# Eval("tieude") %></a></h4>
                                            <p class="post-date">----------------------</p>
                                            <p><%# Eval("Desc").ToString().Length > 45? Eval("Desc").ToString().Substring(0,45) : Eval("Desc") %> ...<a class="#." href='<%# "../" + Eval("url")  %>'>Xem thêm</a></p>
            ...
            <div class="col-md-5">
                ...
                <h2 class="light bordered white-f"><span style="font-size: 14px">Tại Sao Chọn</span> Y Khoa Diamond</h2>

                <div class="panel-group accordian-style2 " id="accordion2">

                    <div class="panel panel-default">
                        <div class="panel-heading" style="background:#1194b3;border-radius:0px;">
