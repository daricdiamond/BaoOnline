                ...
                <div class="large-3 columns ">
                    <article class="post col-2 post-home">
						...
						<div style="width: 115px;overflow:hidden">
							<div style="margin-top: 10px;" class='fb-like' data-href='<%# "~/" + Eval("url")  %>' data-layout='standard' data-action='like' data-show-faces='true' data-share='true'></div>
						</div>
                        <h3>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/" + Eval("url")  %>'> <%# Eval("tieude") %></asp:HyperLink></h3>
