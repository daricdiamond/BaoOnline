...
public partial class Share_layout_Share : System.Web.UI.MasterPage
{
    ...
    private void getBaiMoi()
    {
        ...
        foreach (DataRow row in dt.Rows)
        {
            ...
            html += "<h3><a href='../" + BaseView.GetStringFieldValue(row, "url") + "' title=' " + BaseView.GetStringFieldValue(row, "TieuDe") + "'>" + tieude + "</a></h3></div>";
