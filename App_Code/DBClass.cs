...
public class DBClass : BaseServ
{
    ...
    public DataRow Get_Info_url(string id)
    {
        return GetDataRow("[get_info_url]", id);
    }
	public DataRow get_info_news_url(string url,bool isActived)
    {
        return GetDataRow("[get_info_news_url]", url,isActived);
    }
    ...
    public object OnInsert_Update_Delete_Pages(int autoid, string code, string title, string desc, string keywords, string name, DateTime ngaydang, string tomtat, string noidung, bool isActived, string hinhAnh, string url, string username, string sql)
    {
        SqlParameter[] parameters = new SqlParameter[] { 
            new SqlParameter("@id", SqlDbType.Int),
    ...
    //[]
    public object insert_update_RssGroups(int autoid, string name, string tagtitle, string tagDesc, string tagContent, string sql)
    {
        SqlParameter[] parameters = new SqlParameter[] { 
            new SqlParameter("@id", SqlDbType.Int),
            new SqlParameter("@name", SqlDbType.NVarChar, 500),
        ...
        parameters[0].Value = autoid;
        parameters[1].Value = name;
        parameters[2].Value = tagtitle;
        parameters[3].Value = tagDesc;
        parameters[4].Value = tagContent;
        parameters[5].Value = sql;
        return ExecuteScalar("insert_update_RssGroups", parameters);
    }
    ...
    public object insert_update_delete_cms_user(string username, string mk, string hoten, string cmnd, string dienthoai, bool isactived, bool isadmin,
